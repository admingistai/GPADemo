          ...
          <div id="sidebar-content">
            ...
            <div style="margin-bottom: 16px; border-radius: 8px; border: 1px solid #f3f4f6; background: #fafbfc;">
              <div style="padding: 10px 12px; border-bottom: 1px solid #f3f4f6;">
                <span style="font-size: 15px; font-weight: 600; color: #222;">Widget Position</span>
              </div>
              <div style="padding: 12px;">
                <div id="position-grid" style="
                  display: grid;
                  grid-template-columns: repeat(3, 1fr);
                  gap: 8px;
                  margin-bottom: 8px;
                ">
                  <!-- Grid cells: 0=top-left, 1=top-center, 2=top-right, 3=middle-left, etc. -->
                  <div class="grid-cell" data-position="0" style="
                    aspect-ratio: 1;
                    ...
                    transition: all 0.2s;
                  "></div>
                  <div class="grid-cell" data-position="1" style="
                    aspect-ratio: 1;
                    border: 2px solid #e5e7eb;
                    border-radius: 4px;
                    cursor: pointer;
                    transition: all 0.2s;
                  "></div>
                  <div class="grid-cell" data-position="2" style="
                    aspect-ratio: 1;
                    border: 2px solid #e5e7eb;
                    border-radius: 4px;
                    cursor: pointer;
                    transition: all 0.2s;
                  "></div>
                  <div class="grid-cell" data-position="3" style="
                    aspect-ratio: 1;
                    border: 2px solid #e5e7eb;
                    border-radius: 4px;
                    cursor: pointer;
                    transition: all 0.2s;
                  "></div>
                  <div class="grid-cell" data-position="4" style="
                    aspect-ratio: 1;
                    border: 2px solid #e5e7eb;
                    border-radius: 4px;
                    cursor: pointer;
                    transition: all 0.2s;
                  "></div>
                  <div class="grid-cell" data-position="5" style="
                    aspect-ratio: 1;
                    border: 2px solid #e5e7eb;
                    border-radius: 4px;
                    cursor: pointer;
                    transition: all 0.2s;
                  "></div>
                  <div class="grid-cell" data-position="6" style="
                    aspect-ratio: 1;
                    border: 2px solid #e5e7eb;
                    border-radius: 4px;
                    cursor: pointer;
                    transition: all 0.2s;
                  "></div>
                  <div class="grid-cell" data-position="7" style="
                    aspect-ratio: 1;
                    border: 2px solid #e5e7eb;
                    border-radius: 4px;
                    cursor: pointer;
                    transition: all 0.2s;
                  "></div>
                  <div class="grid-cell" data-position="8" style="
                    aspect-ratio: 1;
                    border: 2px solid #e5e7eb;
                    border-radius: 4px;
                    cursor: pointer;
