...
export default function Home() {
  ...
  const handleGetStartedClick = () => {
    ...
    // Show URL input form instead of redirecting
            ...
            <header className="header">
              <div className="header-left">
                <img 
                  ...
                  alt="Gist" 
                  className="gist-logo" 
                  onClick={() => window.open('https://about.gist.ai', '_blank')} 
                />
              ...
              <section className="hero-section">
                <div className="hero-content">
                  ...
                  <p className="hero-subtitle">
                    Let your visitors ask questions about your content and get instant, accurate answers.
                  </p>
