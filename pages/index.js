...
import AskAnythingForm from '../components/URLInputForm';
...
export default function Home() {
  ...
  const handleQuestionSubmit = async (questionText) => {
    ...
    try {
      // Call a chat API to get an answer
      ...
      setAnswer(result.response || result.message || 'I\'m sorry, I couldn\'t generate an answer to that question.');
      setShowAnswer(true);
    } catch (err) {
        ...
        <div className="answer-page">
          ...
          <main className="answer-content">
            ...
            <div className="answer-actions">
              <button className="ask-another-btn" onClick={handleRetry}>
            ...
            <div className="hero-container">
              <div className="hero-content">
                ...
                <p className="hero-description">
                  Get instant, intelligent answers to any question. Powered by AI and trusted sources.
                </p>
